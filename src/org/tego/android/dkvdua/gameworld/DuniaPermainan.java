 ...
 *
 */
public class DuniaPermainan {
	private GameState currentState;
	// private float gameWidth;
	// private float gameHeight;
	// private GameRenderer renderer;
	private PembuatArena petaGim;
	 ...
	 */
	public DuniaPermainan(float gameWidth, float gameHeight) {
		currentState = GameState.MENU;
		// this.gameWidth = gameWidth;
		// this.gameHeight = gameHeight;
		// petaGim = new PembuatArena(this, (int) gameWidth, (int) gameHeight);
	}
	...
	public void setRenderer(RendDuniaPermainan renderer) {
